...
def fetch_user
  if params[:user_preference] == "true"
    ...
    _weight_age = _value if _value.present?
        ...
        user_preference_list_having_bed_rooms = user_preference.ransack(max_bed_rooms_gteq_any: property&.bed_rooms).result
        _value = calculate_weightage(_weight_age,user_preference_list_having_bed_rooms,14)
        _weight_age = _value if _value.present?
        ...
        user_preference_list_having_price = user_preference.ransack(max_price_gteq_any: property&.price).result
        _value = calculate_weightage(_weight_age,user_preference_list_having_price,14)
        _weight_age = _value if _value.present?
