	...
	def  matching_preference_percentage(user,type,property)
		...
		if type == "user_type"
  			  ...
  			  if _user_preference.present?
  			  	   ...
  			  	   _weight_age = _weight_age + 20 if property.bath_rooms && property.min_bathrooms <= _user_preference.max_bathrooms
  			  	   _weight_age = _weight_age + 20 if property.bed_rooms && property.min_bedrooms <= _user_preference.max_bedrooms
  			  else
  			  	_weight_age
  			  end
		end
